...
en el orden de operaciones). No obstante, para programas que procesan una gran cantidad de datos (pruebas donde ${num_objects=8000}$)
...
en la mejora de resultados al usar 8 hilos, o más bien, en los malos resultados obtenidos por
...
los datos necesarios para el cálculo disminuye los fallos de caché al. Es verdad que gran parte del desarrollo se concentró en SoA,
en lugar de AoS, porque desde un inicio considermos más optimizable por paralelismo y nos permitiría sacar mejores conclusiones
para este proyecto.
