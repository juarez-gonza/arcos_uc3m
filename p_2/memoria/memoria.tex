...
\begin{figure}[htp]
	...
	\hspace*{-2cm}
	\subfloat{%
		\includegraphics[width=0.72\linewidth,height=0.6\linewidth]{resources/8core_samples_conf_interval.png}
		\label{fig:8core}
	}%
	%\hfill%
	\subfloat{%
		\includegraphics[width=0.72\linewidth,height=0.6\linewidth]{resources/16core_samples_conf_interval.png}
		%\caption{Pruebas con 16 núcleos}
		\label{fig:16core}
	}%
	\caption{Pruebas con 8 y 16 núcleos (izquierda y derecha, respectivamente)}
\end{figure}
\begin{figure}[htp]
	%\centering
	\hspace*{-2cm}
	\subfloat{%
		\includegraphics[width=0.72\linewidth,height=0.6\linewidth]{resources/2core_samples_conf_interval.png}
		\label{fig:2core}
	}%
	%\hfill%
	\subfloat{%
		\includegraphics[width=0.72\linewidth,height=0.6\linewidth]{resources/4core_samples_conf_interval.png}
		\label{fig:4core}
	}%
	\caption{Pruebas con 2 y 4 núcleos (izquierda y derecha, respectivamente)}
\end{figure}
\begin{figure}[htp]
	%\centering
	\hspace*{-2cm}
	\subfloat{%
		\includegraphics[width=0.72\linewidth,height=0.6\linewidth]{resources/1core_samples_conf_interval.png}
		%\caption{Pruebas con 16 núcleos}
		\label{fig:1core}
	}%
	%\hfill%
	\subfloat{%
		\includegraphics[width=0.72\linewidth,height=0.6\linewidth]{resources/p_1_samples_conf_interval.png}
		\label{fig:p_1}
	}%
