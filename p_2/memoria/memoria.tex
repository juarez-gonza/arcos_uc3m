...
\begin{figure}[htp]
	...
	\subfloat[Pruebas con 8 hilos de ejecución.]{%
		\includegraphics[width=0.8\linewidth,height=0.65\linewidth]{resources/8core_samples_conf_interval.png}
		\label{fig:8core}
	}%
	%\hfill%
...
\begin{figure}[htp]
	%\centering
	\hspace*{-3.5cm}
	\subfloat[Pruebas con 2 hilos de ejecución.]{%
		\includegraphics[width=0.8\linewidth,height=0.65\linewidth]{resources/2core_samples_conf_interval.png}
		\label{fig:2core}
	}%
	%\hfill%
...
\begin{figure}[htp]
	%\centering
	\hspace*{-3.5cm}
	\subfloat[Pruebas con 1 hilo de ejecución en algoritmo paralelo]{%
		\includegraphics[width=0.8\linewidth,height=0.65\linewidth]{resources/1core_samples_conf_interval.png}
		%\caption{Pruebas con 16 núcleos}
		\label{fig:1core}
	}%
	%\hfill%
	\subfloat[Pruebas con 1 hilo de ejecución en algoritmo secuencial de la sección \ref{original}]{%
		\includegraphics[width=0.8\linewidth,height=0.65\linewidth]{resources/p_1_samples_conf_interval.png}
		\label{fig:p_1}
	}%
	\caption{}
\end{figure}
